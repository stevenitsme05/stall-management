CREATE DATABASE  IF NOT EXISTS `stallv4` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `stallv4`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: stallv4
-- ------------------------------------------------------
...
CREATE TABLE `tbl_ticket` (
  ...
  `strAssigneeName` varchar(45) NOT NULL,
  `booStatus` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`intId`),
...
--
-- Dumping events for database 'stallv4'
--

--
-- Dumping routines for database 'stallv4'
--
...
-- Dump completed on 2019-02-25 20:53:29
